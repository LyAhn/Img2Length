...
class Ui_Img2Length(object):
    def setupUi(self, Img2Length):
        ...
        sizePolicy.setHeightForWidth(self.converted_label.sizePolicy().hasHeightForWidth())
        self.converted_label.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.browseButton.sizePolicy().hasHeightForWidth())
        self.browseButton.setSizePolicy(sizePolicy1)
    ...
    def retranslateUi(self, Img2Length):
        ...
        Img2Length.setWindowFilePath(QCoreApplication.translate("Img2Length", u"c:/", None))
