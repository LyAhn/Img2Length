...
class Ui_Img2Length(object):
    ...
    def retranslateUi(self, Img2Length):
        ...
        self.unitComboBox.setItemText(0, QCoreApplication.translate("Img2Length", u"mm", None))
        self.unitComboBox.setItemText(1, QCoreApplication.translate("Img2Length", u"cm", None))
        self.unitComboBox.setItemText(2, QCoreApplication.translate("Img2Length", u"metre", None))
        self.unitComboBox.setItemText(3, QCoreApplication.translate("Img2Length", u"yard", None))
        self.unitComboBox.setItemText(4, QCoreApplication.translate("Img2Length", u"mile", None))
